...
//validate ip address
void isIpAddress() {
  RegExp reg = RegExp("^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\$");
...
extension flutter_esc_printer on String {
  ...
  bool get isMacAddress  {
    RegExp reg = RegExp("^([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F])\$");
